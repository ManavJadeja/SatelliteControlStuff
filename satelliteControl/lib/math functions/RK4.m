...
%
%   Created by Manav Jadeja on 2022010


%%% COMPUTATION OF UPDATED STATE VECTOR
% 4TH ORDER RUNGE-KUTTA COEFFICIENTS
k1 = dt*dynamics(obj, t,          dt, X,          varargin{:});
k2 = dt*dynamics(obj, t + 0.5*dt, dt, X + 0.5*k1, varargin{:});
k3 = dt*dynamics(obj, t + 0.5*dt, dt, X + 0.5*k2, varargin{:});
k4 = dt*dynamics(obj, t + dt,     dt, X + k3,     varargin{:});
