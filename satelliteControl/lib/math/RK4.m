function [X] = RK4(dynamics, obj, dt, X, varargin)
%%% RK4
...
k1 = dt*dynamics(obj, 0, X, varargin{:});
k2 = dt*dynamics(obj, 0.5*dt, X + 0.5*k1, varargin{:});
k3 = dt*dynamics(obj, 0.5*dt, X + 0.5*k2, varargin{:});
k4 = dt*dynamics(obj, dt, X + k3, varargin{:});
