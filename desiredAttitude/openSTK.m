...
keplerian.SizeShape.SemimajorAxis = 6371+350;   % km
keplerian.SizeShape.Eccentricity = 0;           % unitless
...
% Modify sensor properties
sensorS.CommonTasks.SetPatternSimpleConic(1, 1);
sensorS.CommonTasks.SetPointingAlongVector('Satellite/SPICESat Body.X', 'Satellite/SPICESat North', 0);
