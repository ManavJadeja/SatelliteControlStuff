function [sunTimes, sunVector] = getSunVector(scenario, satellite, interval)
%%% NAME: getSunVector
%
%   INPUTS:
...
[sunTimes, eachCount] = interpolateXs(satLTstart, satLTstop, interval);
...
for i = 1:length(eachCount)
    ...
    satSVDP = satellite.DataProviders.GetDataPrvTimeVarFromPath('Sun Vector/Fixed').Exec(satLTstart(i,:), satLTstop(i,:), interval);
